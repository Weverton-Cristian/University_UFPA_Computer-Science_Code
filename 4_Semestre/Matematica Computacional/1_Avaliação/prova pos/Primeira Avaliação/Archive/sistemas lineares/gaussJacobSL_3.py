...
def gaussJacob(A, b, tol=1e-1, max_iter=100):
    """
...
# Exemplo de uso
A = np.array([[15, 5, 3, 2,2,  1],
              [2, 8, -1, 1, 0,  1],
              [3, -1, 12, 2, -1,  2],
              [-1, 2, 3, 28, 2, -1],
              [4, 1, 0, 3, 30, 2],
              [1, -1, 0, 1, 2, 11]], dtype=np.float64) # Se aumentarmos a matrix A, temos que aumentar no vetor B.

b = np.array([15, 10, 10, 10,8,15], dtype=np.float64)
