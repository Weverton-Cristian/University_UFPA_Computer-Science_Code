...
def F(x):
    ...
    f2 = np.exp(x[1]-2) + x[0]**3-2  # Exemplo: e^x-1 + x³ - 2 = 0, aqui escolhemos a segunda funçao
...
def metodo_de_newton(F, J, x0, epsilon1=1e-3, epsilon2=1e-3, max_iter=100):
...
print("Provando que x e y são soluçao (=0)", solucao[0]**2 + solucao[1]**2 - 2  )
