...
def gaussSeidel(A, b, tol=1e-6, max_iter=100):
    """
    Método iterativo de Gauss-Seidel para resolver sistemas lineares.
    ...
    # Verificar critério de convergência (diagonal dominante)
    for i in range(n):
    ...
    for k in range(max_iter):
        ...
        # Verificar tolerância  // criterio de PARADA
